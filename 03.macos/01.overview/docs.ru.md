...
[Другое](#others) - [Управление лицензией](#license-management) - [Поддержка](#support) - [Проверка обновлений](#updates-check)
...
Первое, что вы увидите после запуска, — это экран с переключателем вкл/выкл. На нём выводится статистика (количество заблокированных рекламных баннеров, трекеров и угроз, сэкономленного трафика), считая с момента установки или последнего ручного сброса статистики.
